...
# Speaker head decorrelation (CER) — exp60: auxiliary only, no SwiGLU / no PP param changes
DECORR_WEIGHT = 0.015
...
# ===================================================================
# Speaker head decorrelation (CER): penalize cosine similarity between speaker rows
# ===================================================================
